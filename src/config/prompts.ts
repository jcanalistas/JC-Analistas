 ...
 * Ligas permitidas: MLS (incluye también la Leagues Cup, el torneo entre clubes de MLS y Liga MX), LaLiga (1ª y 2ª), 1ª RFEF, 2ª RFEF, Liga Portugal, Premier League, Bundesliga, Ligue 1 (Francia), Brasileirão y competiciones europeas (Champions, Europa, Conference).
